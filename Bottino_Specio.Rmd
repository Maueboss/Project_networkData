...
avg_degree_net <- mean(degree(net_overall))
avg_degree_travel <- mean(degree(net_travel))
...
avg_strength_net <- mean(strength(net_overall))
avg_strength_travel <- mean(strength(net_travel))

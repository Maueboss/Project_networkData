...
sum(is.na(overall_dolphins_label))
...
net_overall_dolphins <- graph_from_data_frame(overall_dolphins, directed = FALSE) #from the first 250 rows of the overall_dolphins data
